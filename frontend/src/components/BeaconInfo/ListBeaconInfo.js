...
function ListView() {
  ...
  return (
    <div className='w-screen'>
      <h1 className='text-center font-bold text-6xl text-sky-950'>Active Beacons</h1>
      {beaconList.map((beacon) =>
        <div key={beacon.id} className='box-border w-11/12 m-auto my-3 p-2 border-2 rounded-md bg-white text-sky-950 flex'>
          ...
          <div className='w-1/6 text-center flex-col'>
            <svg className='w-10 h-10 md:w-20 md:h-20 stroke-sky-200 fill-none mx-auto' viewBox='0 0 24 24'>
              <path d="M12 7V12L14.5 10.5M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
