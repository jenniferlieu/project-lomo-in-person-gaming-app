...
Documentation for the classes in the frontend and backend. Documentation for frontend integration (how the frontend and backend are connected using the backend API endpoints) Documentation for the API endpoints.
